...
\relative {
  ...
  \duo {
    ...
    b='8 \rest \stemDown d[ \slashedGrace { \stemUp c=''16_( d } %
  ...
  \repeat volta 2 {
    \duo {
      c''=''2 b~ | b8 d[ d  d] \slashedGrace { c=''16_( d } c8) b a b |
...
\relative {
  ...
  c=4 cM!8 r | {{ template "lh1" }}
  {{ template "lh1" }} a+am!8 r r4 r2 | a4 am!8 am |
