...
\relative {
  ...
  \repeat volta 2 {
    ...
    \af 4\! <g=' b>4 d' <g, b> g | <fis a>\> d~ \af 8\! d8 r16 a'\< a8. \af 16\! b16 |
    \duo { c''=''4 e e fis | } { a'='2 ais=' | } b2~ b8\< d d \af 8\! d |
    {{ rh1() }} e'8. e16 |
    <d='' fis>2~ 8 <c e> <b d>8. <a c>16 | \af 2\! <g b>2~\> 8 d'\< d \af 8\! d |
    {{ rh1() }} fis'8. e16 | <b e g>4 4 r <a b fis'>8. 16 |
    \alternative {
      \volta 1 { <g=' b e>4 <e e'>8. 16 4 r | }
      \volta 2 {
        <g=' b e>4 <e e'>8. 16 4 8. 16 | <e g b e>2 <e'='' g b e>8 r r4 \bar "|."
      }
    }
  }
}
...
\relative {
  ...
  a+am!4 e+a@m cis+fis@7!4 fis+fis7 | b+b7! b+b7 b+b7 d+d7! |
