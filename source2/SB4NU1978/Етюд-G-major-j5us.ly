...
\relative {
  ...
  \time 4/4
  \repeat volta 2 {
    g=16\mp\< a _\aLeg b c d e fis g a b c d e fis g \af 16\! a='' | {{ rh2() }}
  }
  {{ rh1("g=16\\p\\<") }}
  ...
  \repeat volta 2 { {{ rh1("g=16\\mp\\<") }} {{ rh2() }} }
  {{ rh1("g=16\\p\\<") }}
  ...
  \ottava #1 b=''16 c d e fis g a b g='''8\f \ottava #0
  r8 g,,='8-. r \bar "|."
}
{% endmacro %}
...
\relative {
  ...
  fis+b@7!8 r8 g+e@m! r8 dis+b@7! r8 e+em! r | b+b7!8 r c+cM! r d+g@M! r8 r4 |
  \rep 3 { ees+c@m!8 r8 d+d7! r } \rep 3 { d+d7!8 r r4 } |

  {{ lh1("g=,8") }} a r | \rep 3 { d+b@m!8 r8 c+cM! r } d+b@m!8 r8 e+em! r |
