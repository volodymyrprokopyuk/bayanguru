...
\relative {
  ...
  g=''8) r r4 <g, b>8(\< <f d'> | <e c'>4 \af 4\! <c a'>) <c' e>8 <fis, c' d> |
  <g=' b>4 g <e' g>8( <fis, e'> | <b d>4. <g b>8) <fis a>[\> <fis a>] |
  ...
  <g=' d'>2 <bes d>8(\< 8 | <a c>8. <g bes>16 \af 4\! <fis a>4) %
  \duo {
  ...
  \key g \major
  b='16_\aLeg c b a g a b g g' fis g e |
}
{{ end }}
