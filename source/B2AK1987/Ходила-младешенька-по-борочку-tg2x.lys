{% macro rh1() %}
  \afterGrace 1/4 %
    \fixed c' { <g,= a, c e>4^\markup \center-align \smaller "Б+М" } %
...
\relative {
  ...
  <a=' c>8 8 <a d>8 <f a d> | <e=' a e'>4 {{ rh2() }} {{ rh3() }}
  ...
  <e=' a c>16 16 8-> <d g d'>8 8 | <e g e'>4-> <f a>8 <f a b> | {{ rh3() }}
  <c=' e c'>8 8 <d f a d>8 8 | <e a e'>4^\tRit_\dDim {{ rh2() }}
