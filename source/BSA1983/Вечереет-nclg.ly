...
\relative {
  ...
  \time 2/4 a='8. f16 a\> g e \af 16\! f | d4\) %
  \duo {
    f'='8^\(\< d | \time 3/4 g4 <d a'> <g bes>8 \af 8\! <f d'> |
    \time 2/4 <a=' c>8\mf <bes d> <d, f> <e g> |
    \af 8.\! <a,= c f a>4\)\< c'=''8\(\f a |
    \time 3/4 <bes,= bes'>4. <c a'>8 g'[ e] |
    ...
    s4 | s2. | e'='4 bes= |
    s4 <c=' f>4 | d8( e f4) d | <a f'>8 <a d> <a e'>4 | d2~ | d8 c s4 |
    d='8( c16 d bes2) | <a d>8 <a f'> <a= e'>4 | s2 | s4 %
  }
  d='8(\p d | \time 3/4 g4. f16 e d8) bes'( |
  \time 2/4 a='8\>^\tRit g16 f) a8-- \af 8\! g-- |
  <d=' d'>2--\pp \fermata \bar "|."
}
{{ end }}
